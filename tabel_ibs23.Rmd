...
kolom2_6_tabel6_1_kbli = stpim23 %>%
  group_by(KBLI) %>%
  summarise(Total_Input         = sum((r302a_1 + r302b_1 + r303a + r304c + r305a + r311 + r312 + r313) * weight, na.rm = TRUE),
...
writeData(wb, "Tabel 1.1", tabel1_1_kbli)

addWorksheet(wb, "Tabel 2.1")
writeData(wb, "Tabel 2.1", tabel2_1_kbli)

addWorksheet(wb, "Tabel 3.1")
writeData(wb, "Tabel 3.1", tabel3_1_kbli)

addWorksheet(wb, "Tabel 4.1")
writeData(wb, "Tabel 4.1", tabel4_1_kbli)

addWorksheet(wb, "Tabel 5.1")
writeData(wb, "Tabel 5.1", tabel5_1_kbli)

addWorksheet(wb, "Tabel 6.1")
writeData(wb, "Tabel 6.1", tabel6_1_kbli)
