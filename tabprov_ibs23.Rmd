...
writeData(wb, "Tabel 1.2", tabel1_2_prov)

addWorksheet(wb, "Tabel 2.2")
writeData(wb, "Tabel 2.2", tabel2_2_prov)

addWorksheet(wb, "Tabel 3.2")
writeData(wb, "Tabel 3.2", tabel3_2_prov)

addWorksheet(wb, "Tabel 4.2")
writeData(wb, "Tabel 4.2", tabel4_2_prov)

addWorksheet(wb, "Tabel 5.2")
writeData(wb, "Tabel 5.2", tabel5_2_prov)

addWorksheet(wb, "Tabel 6.2")
writeData(wb, "Tabel 6.2", tabel6_2_prov)
